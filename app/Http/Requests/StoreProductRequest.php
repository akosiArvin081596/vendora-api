...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'image' => ['required_without:image_base64', 'image', 'mimes:jpeg,png,jpg,gif,webp', 'max:5120'],
    ...
    public function messages(): array
    {
        return [
            ...
            'image.required_without' => 'Product image is required.',
            'image_base64.required_without' => 'Product image is required.',
